    ...
    <div>
      ...
      <div v-else>
        <div v-for="(result, indexResults) in resultsData" :key="indexResults">
          <component
            :is="isAdmin ? 'UserResults' : 'Results'"
...
import UserFixtures from "@/components/Matches/UserFixtures.vue";
import UserResults from "@/components/Matches/UserResults.vue";

export default {
  name: "MatchesCategoryUser",
  components: {
    Results,
    UserFixtures,
    UserResults,
