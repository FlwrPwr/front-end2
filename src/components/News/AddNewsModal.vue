      ...
      <div class="modal fade" id="addNewsModal" tabindex="-1" aria-labelledby="addNewsModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-width">
            <div class="modal-content">
                <Form @submit="Submit" :validation-schema="schema" ref="addNewsModalFormRef">
...
export default {
  ...
  methods: {
    Submit() {
      ...
      this.$axios.post('/api/Article/create', this.article).then(() => {
        this.$emit('get');
    ...
    ClearModal() {
      this.$refs.addNewsModalFormRef.resetForm();
    }
  },
  computed: {
    schema() {
