<template>
  ...
  <div
    ...
    tabindex="-1"
    role="dialog"
    aria-labelledby="editSponsorModal"
    aria-hidden="true"
  >
    <div class="modal-dialog modal-lg modal-width">
      <Form @submit="Submit" :validation-schema="schema" ref="editSponsorFormRef">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="editSponsorModalLabel">Adauga Trofeu</h5>
            <button
              type="button"
              class="btn-close"
