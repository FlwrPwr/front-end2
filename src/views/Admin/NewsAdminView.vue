  ...
  <div class="newsItem">
    <div class="newsItems">
      <NewsItem
        ...
        @get="GetNews"
        @edit="OpenEditNewsModal"
        @delete="DeleteNews"
      >
      </NewsItem>
      <div :class="{ isDarker: isDarker, mainComponent: true }" @click="OpenAddNewsModal">
        <div class="AddImage">
          <font-awesome-icon class="icon-hover" :icon="['fas', 'plus']" />
        </div>
        <div class="AddText">Add item</div>
      </div>
    </div>
  </div>
  <AddNews ref="addNewsModalRef" @get="GetNews"></AddNews>
  <EditNews
...
import AddNews from "@/components/News/AddNewsModal.vue";
import EditNews from "@/components/News/EditNewsModal.vue";
export default {
  components: {
    NewsItem,
    AddNews,
